<div>
    ...
    <x-form wire:submit.prevent="save">
        <x-slot name="title">
            {{ __('generals.texts.title-update',['name'=> __('generals.titles.state')]) }}
        </x-slot>
        <x-slot name="description">
            {{ __('generals.texts.descriptions-update',['name'=> __('generals.titles.state')]) }}
        </x-slot>
        <x-slot name="form">
            <div class="col-span-6 sm:col-span-4">
                <x-input wire:model.defer="state.state_name"
                         :label="__('generals.tables.name',['name'=>__('generals.titles.state')])"/>
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-input wire:model.defer="state.state_shortname"
