<div>
    ...
    <ol class="relative border-l border-slate-200 dark:border-slate-700 mt-2">
        <li class="mb-4 ml-4 group">
            ...
            <time class="mb-1 text-sm font-normal leading-none text-slate-300">5 hours
                from now
            </time>
            <h3 class="text-sm text-slate-600 font-bold uppercase">Application UI code in Tailwind
                CSS</h3>
        </li>
    </ol>
</div>
