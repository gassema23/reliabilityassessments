    ...
    <x-form wire:submit.prevent="save">
        ...
        <x-slot name="form">
            <div class="col-span-6 sm:col-span-4">
                <x-input wire:model.defer="project_no"
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-datetime-picker
                    ...
                    wire:model.defer="project_due_date"
                    without-time
                    display-format="YYYY-MM-DD"
                />
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-input wire:model.defer="project_name"
                         :label="Str::ucfirst(__('generals.tables.name',['name'=>__('generals.titles.project')]))"
                         :value="old('project_name')"/>
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-textarea wire:model.defer="project_description"
